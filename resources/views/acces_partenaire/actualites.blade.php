                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mx-0">
                                                        <form id="msform" method="post" action="/acces_partenaire/actualites/create" enctype="multipart/form-data">
                                                            ...
                                                            <fieldset>
                                                                <div class="">
                                                                    ...
                                                                    <div class="mb-3 row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input class="form-control mb-0" type="file" name="img">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-1">
                                                                                 ...
                                                                                 <input id="actualite" class="custom-control-input " type="radio" name="type" value="actualite">
                                                                              </div>
                                                                              <div class="col-5 text-start">
                                                                                ...
                                                                                <div class="col-1">
                                                                                  <input id="evenement"  class="custom-control-input" type="radio" name="type" value="evenement">
                                                                              </div>
                                                                              <div class="col-5 text-start">
                                                            ...
                                                            </div> <input type="button" name="previous" class="previous action-button-previous" value="Précédent" /><button type="submit" class="next action-button w-25" >Ajouter l'actualité</button>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-card">

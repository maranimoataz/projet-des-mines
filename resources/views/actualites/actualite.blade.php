                ...
                <div class="row">
                    <div class="info-box pt-0">
                        <div class="section-title pt-5">
                            <h1><B><span style="color: #566885;"
                                        class="px-1">{{ $actualite->titre }}</span></B></h1>
                        </div>
                        <div class="entry-img">
                            <img src="<?php echo url('/'); ?>/{{ $actualite->img }}" style="object-fit: cover;" alt=""
                                class="rounded" height="25%" width="75%">
                        </div>
